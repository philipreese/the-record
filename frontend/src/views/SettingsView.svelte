              ...
              >
                ...
                <div class="flex flex-col gap-3 pl-1 grow pr-4">
                  <div class="flex items-center gap-3 flex-wrap">
                    <span
                      class="text-base lg:text-lg font-light"
                ...
                >
                  ...
                  <div
                    ...
                    title="Background"
                  ></div>
                  <!-- Accent Block — music-mood uses the stored adjusted color so it stays correct even when another theme is active -->
                  <div
                    class="w-1/2 h-full"
      ...
      <div class="space-y-6">
        <div>
          ...
          <p class="text-base font-light text-theme-muted mt-2 leading-relaxed">
            Synchronize your local playback records with your ListenBrainz account history. Note:
            The local database acts as a permanent, cumulative archive—deleting items on
            ListenBrainz will not delete them here.
          </p>
        </div>
        ...
        {#if appCache.syncToken}
          <div class="flex flex-col gap-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="memory-surface-nested flex flex-col justify-between gap-6 bg-transparent">
                <div class="space-y-3">
                  ...
                  <p class="text-base font-light text-theme-secondary leading-relaxed">
                    Scan for recent tracks since your last sync. Safe and fast. Recommended for
                    daily updates.
                  </p>
                </div>
                <div>
              ...
              <div class="memory-surface-nested flex flex-col justify-between gap-6 bg-transparent">
                <div class="space-y-3">
                  ...
                  <p class="text-base font-light text-theme-secondary leading-relaxed">
                    Re-scan your entire ListenBrainz history from the beginning. Rebuilds database
                    records and backfills any gaps.
                  </p>
                </div>
                <div>
                  <button
            ...
            {#if !appCache.isSyncing && appCache.syncStatus?.finished && !appCache.syncError}
              <div
                class="text-xs text-success font-semibold flex items-center gap-1.5 animate-fade-in"
              >
                <svg
