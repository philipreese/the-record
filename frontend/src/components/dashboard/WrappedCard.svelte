      ...
      >
          ...
          <div class="grid grid-cols-1 xl:grid-cols-5 gap-8 xl:gap-12 items-center py-4">
            <div class="xl:col-span-2 space-y-5 text-center xl:text-left">
              <span class="text-xs font-mono tracking-widest text-theme-muted uppercase"
                >{appCache.narrative.plain['wrapped.slide0.section'] || '01 / The Archeology'}</span
              >
              ...
              <p class="text-base font-light leading-relaxed text-theme-secondary">
                <NarrativeText
                  text={(
                    appCache.narrative.rich['wrapped.period_summary'] ||
              ...
              <div class="pt-2">
                <button
                  ...
                  onclick={() => currentStep++}
                >
                  {appCache.narrative.plain['wrapped.slide0.button'] || 'Begin Deep Dive →'}
                </button>
              </div>
            </div>
              ...
              <div class="grid grid-cols-2 gap-6">
                <div class="space-y-1">
                  <span class="text-caps text-xs text-theme-muted"
                    >{appCache.narrative.plain['wrapped.slide0.stat1'] || 'Total Plays'}</span
                  >
                ...
                <div class="space-y-1">
                  <span class="text-caps text-xs text-theme-muted"
                    >{appCache.narrative.plain['wrapped.slide0.stat2'] || 'Minutes Listened'}</span
                  >
                  <div class="text-2xl font-light font-sans tracking-tight text-theme-text">
                ...
                <div class="space-y-1">
                  <span class="text-caps text-xs text-theme-muted"
                    >{appCache.narrative.plain['wrapped.slide0.stat3'] || 'Top Creator'}</span
                  >
                  {#if data.top_artist}
                ...
                <div class="space-y-1">
                  <span class="text-caps text-xs text-theme-muted"
                    >{appCache.narrative.plain['wrapped.slide0.stat4'] || 'Top Track'}</span
                  >
                  {#if data.top_track}
                    <div class="text-lg font-light truncate text-theme-text" use:tooltip>
                ...
                {#if data.peak_day}
                  <div class="col-span-2 pt-6 border-t border-theme-border-soft">
                    <span class="text-caps text-xs text-theme-muted"
                      >{appCache.narrative.plain['wrapped.slide0.stat5'] || 'Peak Intensity'}</span
                    >
                ...
                {#if data.on_repeat_peak}
                  <div class="col-span-2 pt-6 border-t border-theme-border-soft">
                    <span class="text-caps text-xs text-theme-muted"
                      >{appCache.narrative.plain['wrapped.slide0.stat6'] || 'On Repeat'}</span
                    >
        ...
        {:else if currentStep === 1}
          ...
          <div class="text-center space-y-4 py-4">
            <span class="text-xs font-mono tracking-widest text-theme-muted uppercase"
              >{appCache.narrative.plain['wrapped.slide1.section'] || '02 / Duration & Echo'}</span
            >
            <div class="space-y-1">
              ...
              <div class="text-caps text-xs text-theme-muted">
                {appCache.narrative.plain['wrapped.slide1.label'] || 'Total Plays Logged'}
              </div>
            </div>
            <div
            ...
            >
              <NarrativeText
                text={(
                  appCache.narrative.rich['wrapped.slide1.desc'] ||
        ...
        {:else if currentStep === 2}
          ...
          <div class="space-y-8 py-2">
            <div class="text-center">
              <span class="text-xs font-mono tracking-widest text-theme-muted uppercase"
                >{appCache.narrative.plain['wrapped.slide2.section'] || '03 / Key Companions'}</span
              >
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
              ...
              >
                <div class="text-xs font-mono tracking-widest text-theme-muted uppercase">
                  {appCache.narrative.plain['wrapped.slide2.label1'] || 'Top Creator'}
                </div>
                {#if data.top_artist}
              ...
              >
                <div class="text-xs font-mono tracking-widest text-theme-muted uppercase">
                  {appCache.narrative.plain['wrapped.slide2.label2'] || 'Top Track'}
                </div>
                {#if data.top_track}
                  <div class="text-xl md:text-2xl font-light truncate text-theme-text" use:tooltip>
                    {data.top_track.title}
        ...
        {:else if currentStep === 3}
          ...
          <div class="text-center space-y-6 py-4">
            <span class="text-xs font-mono tracking-widest text-theme-muted uppercase"
              >{appCache.narrative.plain['wrapped.slide3.section'] || '04 / Peak Intensity'}</span
            >

            {#if data.peak_day}
              <div class="space-y-2">
                <div class="text-xs font-mono uppercase tracking-widest text-theme-muted">
                  {appCache.narrative.plain['wrapped.slide3.label'] || 'Peak listening day'}
                </div>
              ...
              <p class="text-base font-light max-w-lg mx-auto leading-relaxed text-theme-secondary">
                {appCache.narrative.plain['wrapped.slide3.desc'] ||
        ...
        {:else if currentStep === 4}
          ...
          <div class="text-center space-y-6 py-4">
            <span class="text-xs font-mono tracking-widest text-theme-muted uppercase"
              >{appCache.narrative.plain['wrapped.slide4.section'] || '05 / The Obsession'}</span
            >
            ...
            {#if data.on_repeat_peak}
              ...
              <p class="text-base font-light max-w-lg mx-auto leading-relaxed text-theme-secondary">
                {appCache.narrative.plain['wrapped.slide4.desc'] ||
                  'The single track you returned to most obsessively — a sonic loop that defined its day.'}
              </p>
            {:else}
